document.addEventListener('DOMContentLoaded', () => {
    ...
    function switchTab(tabId) {
        ...
        switch (tabId) {
            ...
            case 'forecasting':
                ...
                elements.tabSubtitle.textContent = "Predictive modeling and sales velocity projection.";
                loadForecastingData();
                break;
            case 'simulation':
    ...
    elements.loginForm.addEventListener('submit', (e) => {
        ...
        if (username === 'admin' && password === 'bistro123') {
            sessionStorage.setItem('bistro_auth', 'true');
            if (elements.rememberMe.checked) {
                localStorage.setItem('bistro_auth_remember', 'admin');
            }
